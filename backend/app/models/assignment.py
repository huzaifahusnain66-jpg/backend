...
class Assignment(db.Model):
    ...
    layout: str = db.Column(db.String(50), nullable=False, default="standard")
    student_name: str = db.Column(db.String(200), nullable=True)
    roll_number: str = db.Column(db.String(100), nullable=True)
    department: str = db.Column(db.String(200), nullable=True)
